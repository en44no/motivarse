...
const variantStyles: Record<ButtonVariant, string> = {
  primary: 'bg-gradient-to-b from-primary to-primary-hover text-white hover:from-primary-hover hover:to-primary active:scale-[0.97] shadow-[var(--shadow-glow-primary)]',
