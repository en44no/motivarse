...
export function MotivationalQuote() {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-surface via-surface to-surface-light p-5 shadow-md"
    >
      ...
      <div className="relative">
        <Quote size={20} className="text-accent/50 mb-3" />
